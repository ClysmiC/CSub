...
public class RewindButton extends JPanel implements MouseListener {
	private CSub csub;
	private int width;
	private int height;
	...
	public RewindButton(CSub c) {
        ...
        try {
        	...
        	InputStream input = classLoader.getResourceAsStream("rewind.png");
