...
public class MinimizeButton extends JPanel implements MouseListener {
    private CSub csub;
    private int width;
    private int height;
    ...
    public MinimizeButton(CSub c) {
        csub = c;

        width = WindowButtonPanel.MINIMIZE_BUTTON_WIDTH;
        height = CSub.WINDOW_BUTTON_PANEL_HEIGHT;
        setPreferredSize(new Dimension(width, height));
        
        backgroundColor = CSub.DEFAULT_COLOR;
        
        //get the image for the minimize button
        try {
        	ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        	InputStream input = classLoader.getResourceAsStream("minimize.png");
    ...
    public void mouseClicked(MouseEvent e) {
        csub.setExtendedState(JFrame.ICONIFIED);
    }
